...
void FileManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->zapisZakonczony((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 1: _t->bladPliku((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->zapiszSlot((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        case 3: _t->sprawdzStan(); break;
        case 4: _t->wyczyscBufor(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_q_method_type _q_method = &FileManager::zapisZakonczony; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (FileManager::*)(const QString & );
            if (_q_method_type _q_method = &FileManager::bladPliku; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FileManager::zapisZakonczony(bool _t1)
{
...
// SIGNAL 1
void FileManager::bladPliku(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
